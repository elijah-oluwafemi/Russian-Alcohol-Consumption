-- Portfolio Project: Russian wine promo
-- Dataset: Russian_alcohol_consumption
-- Columns: year, region, wine, beer, vodka, champagne, brandy
-- Description: This dataset contains the wine consumption per region over a given period of time
-- Objective: To analyze the best regions to carry out profitable wine promo
